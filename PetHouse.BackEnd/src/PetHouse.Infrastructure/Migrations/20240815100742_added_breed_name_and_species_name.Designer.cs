...
namespace PetHouse.Infrastructure.Migrations
{
    ...
    [Migration("20240815100742_added_breed_name_and_species_name")]
    partial class added_breed_name_and_species_name
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetHouse.Domain.Models.Species", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PetHouse.Domain.Models.Species", b =>
                {
                    b.OwnsMany("PetHouse.Domain.Models.Breed", "Breeds", b1 =>
                        {
            ...
            modelBuilder.Entity("PetHouse.Domain.Pet", b =>
                {
                    ...
                    b.OwnsOne("PetHouse.Domain.PetIdentifier", "PetIdentifier", b1 =>
                        {
                            b1.Property<Guid>("PetId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
